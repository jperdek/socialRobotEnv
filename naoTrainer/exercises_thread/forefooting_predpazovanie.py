from exercise_poses.forefooting_predpazovanie import ForefootingPredpazovaniePose
from .exercise import Exercise
import configuration.exercises as exercise_messages_configuration

class ForefootingPredpazovanie(Exercise):
    def __init__(self, messages, widget, app_instance):
        super(ForefootingPredpazovanie, self).__init__(messages, widget, app_instance)
        self.start_msg = messages['start_msg'] + ","

    def forefooting_predpazovanie_exercise(self):
        self.start_timer()

        self.camera_thread.current_exercise = ForefootingPredpazovaniePose()
