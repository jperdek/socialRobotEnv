from exercise_poses.forefooting_rozpazovanie import ForefootingRozpazovaniePose
from .exercise import Exercise
import configuration.exercises as exercise_messages_configuration

class ForefootingRozpazovanie(Exercise):
    def __init__(self, messages, widget, app_instance):
        super(ForefootingRozpazovanie, self).__init__(messages, widget, app_instance)
        self.start_msg = messages['start_msg'] + ","

    def forefooting_rozpazovanie_exercise(self):
        self.start_timer()

        self.camera_thread.current_exercise = ForefootingRozpazovaniePose()
