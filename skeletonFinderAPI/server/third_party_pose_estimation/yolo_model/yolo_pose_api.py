...
from pose_estimate import evaluate_yolo_pose
...
def test_method():
    ...
    evaluation_response = evaluate_yolo_pose(source=encoded_image, is_base64encoded=True)
...
def test_method():
    ...
    evaluation_response = evaluate_yolo_pose(source=encoded_video, number_frames_per_sec=number_frames_per_sec,
